...
public class Client {
    public static void main(String[] args) {
        ...
        new Thread(new Productor(repo),"李师傅").start();
        new Thread(new Productor(repo),"王师傅").start();
        new Thread(new Productor(repo),"张师傅").start();
        new Thread(new Productor(repo),"赵师傅").start();

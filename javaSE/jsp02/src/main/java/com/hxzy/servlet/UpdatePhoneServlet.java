...
public class UpdatePhoneServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String str_id = request.getParameter("id");//要被修改的手机编号
        ...
        Phone phone = new Phone(id, new Series(series), os, networkModel, price);
        ...
        int insert = phoneBiz.update(phone);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (id == null || id.equals("")){
            String path = request.getContextPath() + "/phoneList";//使前端发起一次请求
        ...
        PhoneBiz phoneBiz = new PhoneBizImpl();
        Map<String, Object> phone = phoneBiz.findPhoneById(new Integer(id));
